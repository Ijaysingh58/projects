...
public class client implements ActionListener {
    ...
    static JPanel a1;//for globle access
        ...
        back.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent ae){
                System.exit(0);
                    ...
                    // SET IMAGES TO PROFILE , THE VIDEO , CALL , AND THE THREE DOT : MOERVERT IMAGE ->

                //to set the image from on panel or frame we use imageicon calls which takes the image from the 
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/2.png"));//class loader is used to take image from a location (url)
                //we have to scale the image for perfectly pixed and scale
